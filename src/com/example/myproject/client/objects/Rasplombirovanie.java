...
public class Rasplombirovanie {
	...
	public Rasplombirovanie(int id, String date, int personalAcc, String address, String abonent, long phone,
			String add, String dateKont, int act, String providerDispatcher) {
		super();
		this.id = id;
		this.date = date;
