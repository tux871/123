...
public class AcceptPoverkaActHandler implements ClickHandler {
	long id;
	Postavshik postavshik;
	
	public AcceptPoverkaActHandler(long id, Postavshik postavshik) {
		super();
		this.id = id;
	...
	public void onClick(ClickEvent event) {
		...
		TextBox act = (TextBox) postavshik.table.getWidget(rowIndex, 6);
